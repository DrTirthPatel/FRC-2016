...
static const uint32_t LEFT_MOTOR_FRONT = ;
static const uint32_t LEFT_MOTOR_REAR = ;
static const uint32_t RIGHT_MOTOR_FRONT = ;
static const uint32_t RIGHT_MOTOR_REAR = ;
